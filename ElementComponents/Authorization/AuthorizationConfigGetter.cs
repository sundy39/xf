...
{
    public abstract class AuthorizationConfigGetter
    {
        ...
        public AuthorizationConfigGetter(ElementContext elementContext)
        {
            ElementContext = elementContext;
        }

        public abstract XElement Get(string route);
